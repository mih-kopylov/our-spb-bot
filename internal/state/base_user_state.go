...
func (s *BaseUserState) ClearForm() {
	s.Form = nil
}

func (s *BaseUserState) SetFormField(key FormField, value any) {
	if s.Form == nil {
...
func (s *BaseUserState) GetStringFormField(key FormField) string {
	if s.Form == nil {
		return ""
	}
...
func (s *BaseUserState) GetIntFormField(key FormField) int {
	if s.Form == nil {
		return 0
	}
...
func (s *BaseUserState) GetStringSlice(key FormField) []string {
	if s.Form == nil {
		return nil
	}
...
func (s *BaseUserState) AddValueToStringSlice(key FormField, value string) {
	if s.Form == nil {
		s.Form = map[string]any{}
	}
...
func (s *BaseUserState) RemoveValueFromStringSlice(key FormField, value string) {
	if s.Form == nil {
		s.Form = map[string]any{}
	}
...
func (s *BaseUserState) GetStringMap(key FormField) map[string]string {
	if s.Form == nil {
...
func (s *BaseUserState) PutValueToMap(key FormField, valueKey string, value string) {
